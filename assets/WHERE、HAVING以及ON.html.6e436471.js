import{_ as n,e}from"./app.3fd3d807.js";const s={},a=e(`<h1 id="where\u3001having\u4EE5\u53CAon\u7684\u533A\u522B" tabindex="-1"><a class="header-anchor" href="#where\u3001having\u4EE5\u53CAon\u7684\u533A\u522B" aria-hidden="true">#</a> WHERE\u3001HAVING\u4EE5\u53CAON\u7684\u533A\u522B</h1><h2 id="\u95EE\u9898\u89E3\u7B54" tabindex="-1"><a class="header-anchor" href="#\u95EE\u9898\u89E3\u7B54" aria-hidden="true">#</a> \u95EE\u9898\u89E3\u7B54</h2><p>WHERE \u4E0E HAVING \u7684\u6839\u672C\u533A\u522B\u5728\u4E8E</p><ul><li>WHERE \u5B50\u53E5\u5728 GROUP BY \u5206\u7EC4\u548C\u6570\u636E<strong>\u6C47\u603B</strong>\u4E4B\u524D\u5BF9\u6570\u636E\u8FDB\u884C\u8FC7\u6EE4\uFF1B</li><li>HAVING \u5B50\u53E5\u5728 GROUP BY \u5206\u7EC4\u548C\u6570\u636E<strong>\u6C47\u603B</strong>\u4E4B\u540E\u5BF9\u6570\u636E\u8FDB\u884C\u8FC7\u6EE4\uFF1B</li></ul><div class="language-mysql ext-mysql line-numbers-mode"><pre class="language-mysql"><code>SELECT col1, sum(col2)
FROM t
WHERE codition
GROUP BY col1
HAVING codition;
